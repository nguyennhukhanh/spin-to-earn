...
import { fontInter, fontOpenSans, fontRoboto, fontSans, fontSerif } from '@/assets/fonts';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={siteConfig.description}></meta>
        ...
        <meta name="twitter:creator" content="@spintoearn" />
      ...
      <style jsx global>{`
        html {
          ...
          --font-open-sans: ${fontOpenSans.style.fontFamily};
