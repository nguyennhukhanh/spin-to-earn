        ...
        return (
          <FormItem>
            <div className="relative w-fit">
              <Avatar src={img} className={cn('h-40 w-40 border-3 border-neutral-10', className)} />
              <button
                type="button"
                className="absolute bottom-0 left-1/2 flex h-10 w-10 -translate-x-1/2 items-center justify-center rounded-full border-2 border-neutral-10 bg-neutral-0"
