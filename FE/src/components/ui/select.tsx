...
const SelectTrigger = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, SelectTriggerProps>(
  ({ className, variant, inputSize, fullWidth, iconClassName, arrowIcon: ArrowIcon, children, ...props }, ref) => (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        {ArrowIcon ? (
          <ArrowIcon className={cn('', iconClassName)} />
        ) : (
          <Icons.arrowDown2 className={cn('w-[1.5rem]', iconClassName)} />
        )}
